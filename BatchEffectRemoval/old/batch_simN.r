...
runSim <- function(n,m,r, sigma2, iter =200){
...
varyingN<- lapply(c(1:10), function(x)parLapply(clus,seq(10,200,by = 10), function(n){runSim(n,m=50,r=5,sigma2 = 0.5^2, iter = 200)}))
save(varyingN,file="varyingN.RDa")

# varyingM<- parLapply(clus,seq(10,200,by = 10), function(m){runSim(50,m,5,0.5^2, 2000)})
# save(varyingM,file="varyingM.RDa")

# varyingSigma<- parLapply(clus,seq(0.1,2,length.out = 20), function(sigma){runSim(50,50,5,sigma^2, 2000)})
